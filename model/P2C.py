...
class global_network(nn.Module):
    def __init__(self, image_size, add_L):
        ...
        self.twoD = convrelu(256, 512) #conv4  기존 128,256
        self.threeD = convrelu(512, 256) #conv8 기존 256,512
        self.fourD = convrelu(128, 128) #conv9 기존 512,512
    ...
    def forward(self, x, dim):
        ...
        # out = out.repeat(1, 1, int(self.image_size / n), int(self.image_size / n))  # 주석 처리
        return out
